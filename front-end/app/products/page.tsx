...
import { Filter, ShoppingCart, ChevronLeft, ChevronRight, Eye, X } from 'lucide-react';
...
function ProductsContent() {
  ...
  useEffect(() => {
    ...
    loadProducts();
  }, [category, search, page, brand, isNewArrival, minPrice, maxPrice]);
  ...
  // Load categories and prices on mount
  useEffect(() => {

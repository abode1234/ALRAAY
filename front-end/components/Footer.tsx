        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <a
                href="https://www.facebook.com/people/Al-RAY-TECH-%D8%A7%D9%84%D8%B1%D8%A3%D9%8A-%D8%AA%D9%83%D9%86%D9%88%D9%84%D9%88%D8%AC%D9%8A/61583788877750/?mibextid=wwXIfr&rdid=rdPdBA6lMrkLvX2c&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1MzoXu3ruc%2F%3Fmibextid%3DwwXIfr"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/al.raytech"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 border border-border rounded-md flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors"
              ...
              <a
                href="https://www.tiktok.com/@alray.store?_r=1&_t=ZS-94u3zZ6d6Yh"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 border border-border rounded-md flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors"
                aria-label="TikTok"
